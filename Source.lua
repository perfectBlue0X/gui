...
function Luxt1.CreateWindow(libName, logoId)
    ...
    sideHeading.BackgroundColor3 = Color3.new(0, 0, 0)
    ...
    wave.Size = UDim2.new(0.98, 0, 1.05, 0)  -- Reduced width and height further
    wave.Image = "https://assetdelivery.roblox.com/v1/asset/?id=112579771031225"
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabLogo.Position = UDim2.new(-0.007, 0, 0.067, 1.5)
